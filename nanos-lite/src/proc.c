...
void init_proc() {
	char *argv0[] = {"/bin/cpp-test", NULL}, *envp0[] = {NULL};
	context_uload(&pcb[0], "/bin/cpp-test", argv0, envp0);
	...
	char *argv3[] = {"/bin/nplayer", NULL}, *envp3[] = {NULL};
	context_uload(&pcb[3], "/bin/nplayer", argv3, envp3);
